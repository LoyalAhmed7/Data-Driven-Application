...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain) -> None:
        ...
        self.window = Tk()
        self.window.title("Raquiz Trivia")
        ...
        self.feedback = Label(self.window, pady=10, font=("Red Hat Mono", 15, "bold"))
    ...
    def display_title(self):
        ...
        # Title
        title = Label(self.window, text="Raquiz Application",
                      width=50, bg="lightblue", fg="white", font=("Red Hat Mono", 20, "bold"))
    ...
    def buttons(self):
        ...
        next_button = Button(self.window, text="Next", command=self.next_btn,
                             width=10, bg="blue", fg="white", font=("Red Hat Mono", 16, "bold"))
        ...
        quit_button = Button(self.window, text="Quit", command=self.window.destroy,
                             width=5, bg="red", fg="white", font=("Red Hat Mono", 16, " bold"))
